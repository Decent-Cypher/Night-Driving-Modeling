...
if __name__ == "__main__":
    ...
    test_positions.sort()
    test_velocities = np.ones_like(test_positions, dtype=np.float64) * 0.05
    ...
    plot_traffic_raster(log_p, figsize=(6, 8), filename='output_images/raster_plot_fig5.png')
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig('output_images/average_velocity_over_time_fig5.png', dpi=300, bbox_inches='tight')