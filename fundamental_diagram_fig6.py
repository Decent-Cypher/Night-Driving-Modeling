...
if __name__ == "__main__":
    ...
    plot_fundamental_diagram(
        ...
        _lambda=0.1,
        delta_t=0.1,
        filename="output_images/fundamental_diagram_normal_fig6.png",
    )
    plot_fundamental_diagram(
        ...
        _lambda=0.1,
        delta_t=0.1,
        filename="output_images/fundamental_diagram_night_fig6.png",
    )
    plot_fundamental_diagram(
        optimal_velocity_function=test_night_optimal_velocity,
        simulation_steps=SIMULATION_STEPS,
        ...
        n_dec=1,
        delta_t=0.4,
        filename="output_images/fundamental_diagram_night_fig6_perturb.png",
    )